...
<p align="center">
  ...
  Utilização de uma tabela para revisar e consolidar todos os principais conceitos do MySql. Normalizando e populando uma tabela não normalizada para executar queries com o intuito de encontrar as informações solicitadas.
<br />

Habilidades desenvolvidas
 - Normalização de uma tabela na terceira forma normal e acesso as informações desta tabela através de queries utilizando SQL.
</p>
